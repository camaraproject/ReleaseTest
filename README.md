...
* The latest pre-release is [r1.4](https://github.com/camaraproject/ReleaseTest/releases/tag/r1.4) (release candidate), with the following API versions:
  * **release-test 1.0.0-rc.3**
  [[YAML]](https://github.com/camaraproject/ReleaseTest/blob/r1.4/code/API_definitions/release-test.yaml)  [[ReDoc]](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/camaraproject/ReleaseTest/r1.4/code/API_definitions/release-test.yaml&nocors)  [[Swagger]](https://camaraproject.github.io/swagger-ui/?url=https://raw.githubusercontent.com/camaraproject/ReleaseTest/r1.4/code/API_definitions/release-test.yaml)
