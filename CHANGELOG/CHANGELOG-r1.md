...
## What's Changed
* Release Automation: Post-release sync (r1.1) by @camara-release-automation[bot] in https://github.com/camaraproject/ReleaseTest/pull/189
* Update target release tag to r1.2 by @hdamker in https://github.com/camaraproject/ReleaseTest/pull/190
* test: drift code/common to exercise sync-common idempotency (#306) by @hdamker in https://github.com/camaraproject/ReleaseTest/pull/195
* Sync common files from Commonalities r4.3 by @camara-release-automation[bot] in https://github.com/camaraproject/ReleaseTest/pull/197
